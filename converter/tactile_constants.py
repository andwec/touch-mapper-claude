...
BUILDING_ROOF_HEIGHT_MM = 1.0
# How far LOD2 solid buildings are sunk into the base plate so they fuse with it.
BUILDING_BASE_SINK_MM = 0.5

WATER_TOWER_SHAFT_RADIUS_MM = 0.8
WATER_TOWER_TANK_RADIUS_MM = 1.8
BASE_HEIGHT_MM = 0.6
