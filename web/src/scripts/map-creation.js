...
(function(){
  ...
  window.submitMapCreation = function() {
    ...
    var msg = {
      ...
      roadHeightFactor: parseFloat(data.get("road-height-factor")) || 1,
      buildingHeightFactor: parseFloat(data.get("building-height-factor")) || 1,
      baseHeightFactor: parseFloat(data.get("base-height-factor")) || 1,
      waterDepthFactor: parseFloat(data.get("water-depth-factor")) || 1,
      terrainHeightFactor: (function(){ var v = parseFloat(data.get("terrain-height-factor")); return isNaN(v) ? 1 : v; })(),
      terrainSmoothing: (function(){ var v = parseFloat(data.get("terrain-smoothing")); return isNaN(v) ? 2 : v; })(),
      export3mf: data.get("export-3mf") || false,
